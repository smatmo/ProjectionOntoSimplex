...
if __name__ == "__main__":
    ...
    print()
    print("Nonnegativety violation {:0.12f} detected.".format(nonneg_violation))
    print("l1 violation violation {:0.12f} detected.".format(l1_violation))
    print("suboptimality {:0.12f} detected.".format(suboptimality))
    print()
